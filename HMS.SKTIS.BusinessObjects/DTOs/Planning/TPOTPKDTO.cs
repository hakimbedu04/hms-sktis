...
namespace HMS.SKTIS.BusinessObjects.DTOs.Planning
{
    public class TPOTPKDTO
    {
        ...
        public decimal? Target1
        {
            get
            {
                return Math.Round((Convert.ToDecimal(WorkerAlocation) * Convert.ToDecimal(HistoricalCapacityWorker1) * Convert.ToDecimal(PercentAttendance1) * Convert.ToDecimal(DailyWHWeightedResult1)), 6);
            }
        }
        public decimal? Target2
        {
            get
            {
                return Math.Round((Convert.ToDecimal(WorkerAlocation) * Convert.ToDecimal(HistoricalCapacityWorker2) * Convert.ToDecimal(PercentAttendance2) * Convert.ToDecimal(DailyWHWeightedResult2)), 6);
            }
        }
        public decimal? Target3
        {
            get
            {
                return Math.Round((Convert.ToDecimal(WorkerAlocation) * Convert.ToDecimal(HistoricalCapacityWorker3) * Convert.ToDecimal(PercentAttendance3) * Convert.ToDecimal(DailyWHWeightedResult3)), 6);
            }
        }
        public decimal? Target4
        {
            get
            {
                return Math.Round((Convert.ToDecimal(WorkerAlocation) * Convert.ToDecimal(HistoricalCapacityWorker4) * Convert.ToDecimal(PercentAttendance4) * Convert.ToDecimal(DailyWHWeightedResult4)), 6);
            }
        }
        public decimal? Target5
        {
            get
            {
                return Math.Round((Convert.ToDecimal(WorkerAlocation) * Convert.ToDecimal(HistoricalCapacityWorker5) * Convert.ToDecimal(PercentAttendance5) * Convert.ToDecimal(DailyWHWeightedResult5)), 6);
            }
        }
        public decimal? Target6
        {
            get
            {
                return Math.Round((Convert.ToDecimal(WorkerAlocation) * Convert.ToDecimal(HistoricalCapacityWorker6) * Convert.ToDecimal(PercentAttendance6) * Convert.ToDecimal(DailyWHWeightedResult6)), 6);
            }
        }
        public decimal? Target7
        {
            get
            {
                return Math.Round((Convert.ToDecimal(WorkerAlocation) * Convert.ToDecimal(HistoricalCapacityWorker7) * Convert.ToDecimal(PercentAttendance7) * Convert.ToDecimal(DailyWHWeightedResult7)), 6);
            }
        }
