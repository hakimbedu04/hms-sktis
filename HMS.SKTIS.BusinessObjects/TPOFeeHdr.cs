...
namespace HMS.SKTIS.BusinessObjects
{
    ...
    public partial class TPOFeeHdr
    {
        public TPOFeeHdr()
        {
            this.TPOFeeCalculations = new HashSet<TPOFeeCalculation>();
            this.TPOFeeProductionDailies = new HashSet<TPOFeeProductionDaily>();
        }
        ...
        public Nullable<double> TotalJKN { get; set; }
        public Nullable<double> TotalJL1 { get; set; }
        public Nullable<double> TotalJL2 { get; set; }
        public Nullable<double> TotalJL3 { get; set; }
        public Nullable<double> TotalJL4 { get; set; }
    
        public virtual MstGenBrandGroup MstGenBrandGroup { get; set; }
        public virtual MstTPOInfo MstTPOInfo { get; set; }
        public virtual ICollection<TPOFeeCalculation> TPOFeeCalculations { get; set; }
        public virtual ICollection<TPOFeeProductionDaily> TPOFeeProductionDailies { get; set; }
    }
}
