/****** Object:  StoredProcedure [dbo].[InsertPlantExeReportByGroups]    Script Date: 8/27/2016 5:45:55 PM ******/
SET ANSI_NULLS ON
GO
...
AS
    BEGIN
		...
		BEGIN
			...
			DECLARE @TotalActualValueDummyR REAL; -- Resmi
			DECLARE @TotalActualValueDummyM REAL; -- Multiskill

			SELECT @TotalActualValueDummyR = SUM(en.ProdActual) FROM ExePlantProductionEntry en 
			WHERE en.ProductionEntryCode = @ProductionCodeDummy AND en.StatusEmp = 'Resmi';

			SELECT @TotalActualValueDummyM = SUM(en.ProdActual) FROM ExePlantProductionEntry en 
			WHERE en.ProductionEntryCode = @ProductionCodeDummy AND en.StatusEmp = 'Multiskill';

			UPDATE ExePlantProductionEntryVerification SET VerifySystem = 1
			...
			BEGIN
               ...
               SELECT TOP 1 eppev.LocationCode,
                      ...
                      0 AS Multi_WRP,
                      [dbo].GetAbsent( eppev.ProductionEntryCode, 'T' ) [Out],
                      COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Resmi' ) [Attend],
                      GETDATE() CreatedDate,
                      @CreatedBy CreatedBy,
                      GETDATE() UpdatedDate,
                      @CreatedBy UpdateBy,
                      COUNT(en.EmployeeID) Register,
                      COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Resmi' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Resmi' ) AS [In],
                      eppev.KPSYear,
                      eppev.KPSWeek,
					 CASE WHEN WorkHour != 0
			...
			FROM dbo.ExePlantProductionEntryVerification eppev
               ...
               SELECT TOP 1 eppev.LocationCode,
                      ...
                      0 AS Multi_WRP,
                      [dbo].GetAbsent( eppev.ProductionEntryCode, 'T' ) [Out],
                      COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Multiskill' ) [Attend],
                      GETDATE() CreatedDate,
                      @CreatedBy CreatedBy,
                      GETDATE() UpdatedDate,
                      @CreatedBy UpdatedDate,
                      COUNT(en.EmployeeID) Register,
                      COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Multiskill' ) AS [In],
                      eppev.KPSYear,
                      eppev.KPSWeek,
					 CASE WHEN WorkHour != 0
						THEN COALESCE(CAST(round(SUM(en.ProdActual) * pslv.UOMEblek, 0) AS REAL) / NULLIF(dbo.CalculateWorkHours(@LocationCode, @Unit, @GroupCode, @Brand, @Shift, eppev.ProcessGroup, @Date, @Year, @Week, (select datepart(dw, @Date))), 0), 0)
						...
						ELSE 0
						END ValueHour,
					  CASE WHEN (COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Multiskill' )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' ) != 0 AND round(SUM(en.ProdActual) * pslv.UOMEblek, 0) != 0
						THEN COALESCE(
							CAST(round(SUM(en.ProdActual) * pslv.UOMEblek, 0) AS REAL) / NULLIF(CAST(((COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Multiskill' )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' )) AS FLOAT) , 0), 0)
						ELSE 0
						END ValuePeople,
						(COALESCE(COALESCE(CAST(round(SUM(en.ProdActual) * pslv.UOMEblek, 0) AS REAL) / NULLIF(dbo.CalculateWorkHours(@LocationCode, @Unit, @GroupCode, @Brand, @Shift, eppev.ProcessGroup, @Date, @Year, @Week, (select datepart(dw, @Date))), 0), 0) / NULLIF(CAST(((COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Multiskill' )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' )) as FLOAT), 0), 0)) ValuePeopleHour,
						--(COALESCE(CAST(eppev.TotalActualValue AS FLOAT) / NULLIF(CAST(([dbo].GetEmployeeEblekCount(eppev.ProductionEntryCode) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' )) as FLOAT), 0), 0)) / NULLIF(COALESCE(DATEDIFF(HOUR, ( DATEADD(MINUTE, (( DATEPART(HOUR, eawh.TimeIn) * 60 ) + DATEPART(MINUTE, eawh.TimeIn) * 60 ) + DATEPART(SECOND, eawh.TimeIn), eawh.BreakTime)), eawh.TimeOut), 7), 0) ValuePeopleHour,
					  (COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', 'Multiskill' ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, 'Multiskill' )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' ) ActualWorker,
			...
			BEGIN
               ...
               SELECT TOP 1 eppev.LocationCode,
                     ...
                     [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', @statusEmp ) Absence_A,
                      ...
                      0 AS Multi_WRP,
                      [dbo].GetAbsent( eppev.ProductionEntryCode, 'T' ) [Out],
                      COUNT(en.EmployeeID) - [dbo].GetAbsent( eppev.ProductionEntryCode, 'A' ) - [dbo].GetAbsent( eppev.ProductionEntryCode, 'I' ) - [dbo].GetAbsent( eppev.ProductionEntryCode, 'C' ) - [dbo].GetAbsent( eppev.ProductionEntryCode, 'CH' ) - [dbo].GetAbsent( eppev.ProductionEntryCode, 'CT' ) - [dbo].GetAbsent( eppev.ProductionEntryCode, 'SLS' ) - [dbo].GetAbsent( eppev.ProductionEntryCode, 'SLP' ) - [dbo].GetAbsent( eppev.ProductionEntryCode, NULL ) [Attend],
                      GETDATE() CreatedDate,
                      @CreatedBy CreatedBy,
                      GETDATE() UpdatedDate,
                      @CreatedBy UpdatedDate,
					 ...
					 CASE WHEN WorkHour != 0
						...
						ELSE 0
						END ValueHour,
					  CASE WHEN (COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, @statusEmp )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' ) != 0 AND round(SUM(en.ProdActual) * pslv.UOMEblek, 0) != 0
						THEN COALESCE(
							CAST(round(SUM(en.ProdActual) * pslv.UOMEblek, 0) AS REAL) / NULLIF(CAST(((COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, @statusEmp )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' )) AS FLOAT) , 0), 0)
						ELSE 0
						END ValuePeople,
						(COALESCE(COALESCE(CAST(round(SUM(en.ProdActual) * pslv.UOMEblek, 0) AS REAL) / NULLIF(dbo.CalculateWorkHours(@LocationCode, @Unit, @GroupCode, @Brand, @Shift, eppev.ProcessGroup, @Date, @Year, @Week, (select datepart(dw, @Date))), 0), 0) / NULLIF(CAST(((COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, @statusEmp )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' )) as FLOAT), 0), 0)) ValuePeopleHour,
						--(COALESCE(CAST(eppev.TotalActualValue AS FLOAT) / NULLIF(CAST(([dbo].GetEmployeeEblekCount(eppev.ProductionEntryCode) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' )) as FLOAT), 0), 0)) / NULLIF(COALESCE(DATEDIFF(HOUR, ( DATEADD(MINUTE, (( DATEPART(HOUR, eawh.TimeIn) * 60 ) + DATEPART(MINUTE, eawh.TimeIn) * 60 ) + DATEPART(SECOND, eawh.TimeIn), eawh.BreakTime)), eawh.TimeOut), 7), 0) ValuePeopleHour,
					  (COUNT(en.EmployeeID) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'A', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'I', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'S', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'C', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CH', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'CT', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLS', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, 'SLP', @statusEmp ) - [dbo].[GetAbsentAssignmentOnEntry]( eppev.ProductionEntryCode, NULL, @statusEmp )) - dbo.GetAbsent( eppev.ProductionEntryCode, 'MO' ) ActualWorker,
		...
		--EXEC [dbo].[RECALCULATEREPORTBYGROUPWEEKLY] @LocationCode, @GroupCode, @Brand, @Week, @Year, @Date
		--EXEC [dbo].[RECALCULATEREPORTBYGROUPMONTHLY] @LocationCode, @GroupCode, @Brand, @Week, @Year, @Date
