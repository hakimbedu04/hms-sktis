/****** Object:  StoredProcedure [dbo].[INSERT_WORKER_ABSENTEEISM]    Script Date: 7/21/2016 1:57:08 PM ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN TRY
     ...
     VALUES
		...
		BEGIN
			...
			IF(
				@SktAbsentCode = 'C' OR @SktAbsentCode = 'S' OR @SktAbsentCode = 'CT' OR @SktAbsentCode = 'CH' OR @SktAbsentCode = 'SKR'
				OR @SktAbsentCode = 'LP1' OR @SktAbsentCode = 'T' OR @SktAbsentCode = 'CT' OR @SktAbsentCode = 'TL' OR @SktAbsentCode = 'A'  
			  )
			BEGIN
				UPDATE ExePlantProductionEntry 
				SET 
