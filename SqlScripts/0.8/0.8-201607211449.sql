USE [SKT_DEV]
GO
/****** Object:  UserDefinedFunction [dbo].[GetUserAndEmail]    Script Date: 21/07/2016 14:43:45 ******/
SET ANSI_NULLS ON
GO
...
AS
BEGIN
	IF(@FunctionName LIKE 'EblekReleaseApproval') OR (@FunctionName LIKE 'PlantTargetProductionGroup') OR (@FunctionName LIKE 'ProductionEntryVerification') OR (@FunctionName LIKE 'ProductionCard')
	BEGIN
