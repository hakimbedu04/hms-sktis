GO
/****** Object:  StoredProcedure [dbo].[INSERT_WORKER_ASSIGNMENT_BYSYSTEM]    Script Date: 8/26/2016 3:50:54 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT DISTINCT EmployeeID FROM @temp
	OPEN MY_CURSOR
	FETCH NEXT FROM MY_CURSOR INTO @Employee
