/****** Object:  StoredProcedure [dbo].[INSERT_WORKER_ASSIGNMENT]    Script Date: 7/25/2016 2:12:45 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			SET @DestinationGroupCodeDummy = @DestinationGroupCodeDummy + 'R';
		END;
		ELSE
		BEGIN
			SET @DestinationGroupCodeDummy = @DestinationGroupCodeDummy + 'M';
		END;
