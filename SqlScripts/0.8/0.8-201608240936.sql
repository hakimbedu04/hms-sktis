/****** Object:  View [dbo].[ExeReportByStatusView]    Script Date: 8/24/2016 9:30:14 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Description: Adding multiskill to absen
-- Author: Azka - 2016/08/24
-- =============================================
...
SELECT        
	...
	+ ISNULL(g.Absennce_A, 0) + ISNULL(g.Multi_CUTT, 0) + ISNULL(g.Multi_FWRP, 0) + ISNULL(g.Multi_GEN, 0) + ISNULL(g.Multi_PACK, 0) + ISNULL(g.Multi_ROLL, 0) + ISNULL(g.Multi_STAMP, 0) + iSNULL(g.Multi_SWRP, 0) + ISNULL(g.Multi_TPO, 0) + ISNULL(g.Multi_WRP, 0)
