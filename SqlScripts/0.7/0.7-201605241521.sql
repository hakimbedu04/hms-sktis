...
/****** Object:  View [dbo].[MntcInventoryDeltaView]    Script Date: 24/05/2016 14:45:49 ******/
SET ANSI_NULLS ON
GO
...
AS
     ...
     FROM(
         ...
         SELECT b.InventoryDate,
                ...
                SUM(QtyRepairRequest + QtyBadStock) AS DeltaStockOut,
                SUM(QtyRepairRequest - ( QtyRepairRequest + QtyBadStock )) AS DeltaStak
