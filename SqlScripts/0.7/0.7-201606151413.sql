...
AS
	...
	SET @TotalProdJKN = ROUND((( @TPOPackageValue * @StdStickPerHours * @TotalJKN * @EmpPackage ) / @StickPerBox ), 0);
	SET @TotalProdJl1 = ROUND((( @TPOPackageValue * @StdStickPerHours * @TotalJL1 * @EmpPackage ) / @StickPerBox ), 0);
	SET @TotalProdJl2 = ROUND((( @TPOPackageValue * @StdStickPerHours * @TotalJL2 * @EmpPackage ) / @StickPerBox ), 2);
	SET @TotalProdJl3 = ROUND((( @TPOPackageValue * @StdStickPerHours * @TotalJL3 * @EmpPackage ) / @StickPerBox ), 2);
	SET @TotalProdJl4 = ROUND((( @TPOPackageValue * @StdStickPerHours * @TotalJL4 * @EmpPackage ) / @StickPerBox ), 2);
	
	-- JKN (round tanpa desimal)
	IF (ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @tProdJl3 - @tProdJl4, 0) <= @TotalProdJKN)
		BEGIN
			SET @TotalProdJKN = ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @tProdJl3 - @tProdJl4, 0);
		END
	
	-- JL1 (round tanpa desimal)
	IF(ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @TotalProdJKN - @tProdJl3 - @tProdJl4, 0) > 0 )
		BEGIN
			IF(ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @TotalProdJKN - @tProdJl3 - @tProdJl4, 0) <= @TotalProdJl1)
				BEGIN
					SET @TotalProdJl1 = ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @TotalProdJKN - @tProdJl3 - @tProdJl4, 0);
				END
		END
	ELSE
		BEGIN
	...
	-- JL2
	IF(ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @TotalProdJKN - @TotalProdJl1 - @tProdJl3 - @tProdJl4, 2) > 0 )
		BEGIN
			-- SET @TotalProdJl2 = ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @TotalProdJKN - @TotalProdJl1 - @tProdJl3 - @tProdJl4, 2);
			SET @TotalProdJl2 = ROUND(@tProdJKN + @tProdJl1 + @tProdJl2 - @TotalProdJKN - @TotalProdJl1 - @tProdJl3 - @tProdJl4, 0);
	...
	-- JL3
	DECLARE @Standard60 FLOAT = ROUND((( @TPOPackageValue * @StdStickPerHours * @EmpPackage * 60 ) / @StickPerBox ), 2);
    ...
    SELECT @PPNProductivityIncentives = Value FROM TPOFeeSettingCalculation WHERE Name ='PPN Productivity Incentives'
     ...
     --SET @OutputProduction1 = @TotalProdJKN
     ...
     -- (Get data EmpPackage from MstGenBrandGroup where Filter) / @StickPerBox
     --SET @OutputProduction2 = @TotalProdJl1
     ...
     -- (Get data EmpPackage from MstGenBrandGroup where Filter) / @StickPerBox
     --SET @OutputProduction3 = @TotalProdJl2
     ...
     -- (Get data EmpPackage from MstGenBrandGroup where Filter) / @StickPerBox
     --SET @OutputProduction4 = @TotalProdJl3
     ...
     -- (Get data EmpPackage from MstGenBrandGroup where Filter) / @StickPerBox
     --SET @OutputProduction5 = @TotalProdJl4
         ...
         END;
             ...
             IF NOT EXISTS( SELECT * FROM TPOFeeCalculation WHERE dbo.TPOFeeCalculation.TPOFeeCode = @parentid )
                 BEGIN
                     ...
                     VALUES( @parentid, 'JKN', @KPSYear, @KPSWeek, 1, @OutputProduction1, @OutputBiaya1, @Calculate1 ),
                           ( @parentid, 'JL1', @KPSYear, @KPSWeek, 2, @OutputProduction2, @OutputBiaya2, @Calculate2 ),
                           ( @parentid, 'JL2', @KPSYear, @KPSWeek, 3, @OutputProduction3, @OutputBiaya3, @Calculate3 ),
                           ( @parentid, 'JL3', @KPSYear, @KPSWeek, 4, @OutputProduction4, @OutputBiaya4, @Calculate4 ),
                           ( @parentid, 'JL4', @KPSYear, @KPSWeek, 5, @OutputProduction5, @OutputBiaya5, @Calculate5 ),
                           ( @parentid, 'Biaya Produksi', @KPSYear, @KPSWeek, 6, @OutputProduction6, @OutputBiaya6, @Calculate6 ),
                           ( @parentid, 'Jasa Manajemen', @KPSYear, @KPSWeek, 7, @OutputProduction7, @OutputBiaya7, @Calculate7 ),
                           ( @parentid, 'Productivity Incentives', @KPSYear, @KPSWeek, 16, @OutputProduction16, @OutputBiaya16, @Calculate16 ),
                           ( @parentid, 'Total Biaya Produksi & Jasa Maklon', @KPSYear, @KPSWeek, 8, @OutputProduction8, @OutputBiaya8, @Calculate8 ),
                           ( @parentid, 'Pajak Jasa Manajemen Sebesar 2%', @KPSYear, @KPSWeek, 9, @OutputProduction9, @OutputBiaya9, @Calculate9 ),
                           ( @parentid, 'Pajak Productivity Incentives sebesar 2 %', @KPSYear, @KPSWeek, 17, @OutputProduction17, @OutputBiaya17, @Calculate17 ),
                           ( @parentid, 'Total Biaya Yang Harus Dibayarkan Ke MPS', @KPSYear, @KPSWeek, 10, @OutputProduction10, @OutputBiaya10, @Calculate10 ),
                           ( @parentid, 'Pembayaran', @KPSYear, @KPSWeek, 11, @OutputProduction11, @OutputBiaya11, @Calculate11 ),
                           ( @parentid, 'Sisa yang harus dibayar', @KPSYear, @KPSWeek, 12, @OutputProduction12, @OutputBiaya12, @Calculate12 ),
                           ( @parentid, 'PPN Biaya Produksi 10%', @KPSYear, @KPSWeek, 13, @OutputProduction13, @OutputBiaya13, @Calculate13 ),
                           ( @parentid, 'PPN Jasa Manajemen 10%', @KPSYear, @KPSWeek, 14, @OutputProduction14, @OutputBiaya14, @Calculate14 ),
                           ( @parentid, 'PPN Productivity Incentives 10 %', @KPSYear, @KPSWeek, 18, @OutputProduction18, @OutputBiaya18, @Calculate18 ),
                           ( @parentid, 'Total Bayar', @KPSYear, @KPSWeek, 15, @OutputProduction15, @OutputBiaya15, @Calculate15 );
                 END;
             ELSE
                 BEGIN
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction1, OutputBiaya = @OutputBiaya1, Calculate = @Calculate1 WHERE TPOFeeCode = @parentid AND OrderFeeType = 1;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction2, OutputBiaya = @OutputBiaya2, Calculate = @Calculate2 WHERE TPOFeeCode = @parentid AND OrderFeeType = 2;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction3, OutputBiaya = @OutputBiaya3, Calculate = @Calculate3 WHERE TPOFeeCode = @parentid AND OrderFeeType = 3;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction4, OutputBiaya = @OutputBiaya4, Calculate = @Calculate4 WHERE TPOFeeCode = @parentid AND OrderFeeType = 4; 
				 UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction5, OutputBiaya = @OutputBiaya5, Calculate = @Calculate5 WHERE TPOFeeCode = @parentid AND OrderFeeType = 5;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction6, OutputBiaya = @OutputBiaya6, Calculate = @Calculate6 WHERE TPOFeeCode = @parentid AND OrderFeeType = 6;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction7, OutputBiaya = @OutputBiaya7, Calculate = @Calculate7 WHERE TPOFeeCode = @parentid AND OrderFeeType = 7;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction16, OutputBiaya = @OutputBiaya16, Calculate = @Calculate16 WHERE TPOFeeCode = @parentid AND OrderFeeType = 16;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction8, OutputBiaya = @OutputBiaya8, Calculate = @Calculate8 WHERE TPOFeeCode = @parentid AND OrderFeeType = 8;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction9, OutputBiaya = @OutputBiaya9, Calculate = @Calculate9 WHERE TPOFeeCode = @parentid AND OrderFeeType = 9;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction17, OutputBiaya = @OutputBiaya17, Calculate = @Calculate17 WHERE TPOFeeCode = @parentid AND OrderFeeType = 17;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction10, OutputBiaya = @OutputBiaya10, Calculate = @Calculate10 WHERE TPOFeeCode = @parentid AND OrderFeeType = 10;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction11, OutputBiaya = @OutputBiaya11, Calculate = @Calculate11 WHERE TPOFeeCode = @parentid AND OrderFeeType = 11;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction12, OutputBiaya = @OutputBiaya12, Calculate = @Calculate12 WHERE TPOFeeCode = @parentid AND OrderFeeType = 12;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction13, OutputBiaya = @OutputBiaya13, Calculate = @Calculate13 WHERE TPOFeeCode = @parentid AND OrderFeeType = 13;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction14, OutputBiaya = @OutputBiaya14, Calculate = @Calculate14 WHERE TPOFeeCode = @parentid AND OrderFeeType = 14;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction18, OutputBiaya = @OutputBiaya18, Calculate = @Calculate18 WHERE TPOFeeCode = @parentid AND OrderFeeType = 18;
                     UPDATE dbo.TPOFeeCalculation SET OutputProduction = @OutputProduction15, OutputBiaya = @OutputBiaya15, Calculate = @Calculate15 WHERE TPOFeeCode = @parentid AND OrderFeeType = 15;
                 END;
