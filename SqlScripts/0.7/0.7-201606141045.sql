/****** Object:  UserDefinedFunction [dbo].[GetReportProdStockProcessView]    Script Date: 6/14/2016 10:39:09 AM ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN Planning F ON F.BrandGroupCode = P.BrandGroupCode AND F.BrandCode = P.BrandCode AND F.LocationCode = P.LocationCode AND F.UnitCode = P.UnitCode
