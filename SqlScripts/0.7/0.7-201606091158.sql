...
-- =============================================
CREATE PROCEDURE dbo.RecalculateStockExeReportByProcess
	@productionDate date,
...
BEGIN
	...
	targetTable
	SET 
		targetTable.BeginningStock = ISNULL((targetTable.BeginningStock + source.Delta),targetTable.BeginningStock),
		targetTable.EndingStock = ISNULL((targetTable.EndingStock + source.Delta),targetTable.EndingStock)
	FROM(
		SELECT 
			base.LocationCode,
		   base.UnitCode,
