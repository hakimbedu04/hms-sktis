IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WAGES_ABSENT_REPORT_BYEMPLOYEE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[WAGES_ABSENT_REPORT_BYEMPLOYEE]
...
CREATE PROCEDURE [dbo].[WAGES_ABSENT_REPORT_BYEMPLOYEE]
(	
		@paramStartDate DATE
	,	@paramEndDate	DATE
