/****** Object:  StoredProcedure [dbo].[GENERATE_PRODUCTION_CARD]    Script Date: 12/5/2016 9:44:33 AM ******/
SET ANSI_NULLS ON
GO
			...
			BEGIN
				...
				BEGIN
					...
					SET @ProductionCardCode = 'WPC/' + @LocationCode 
					 ...
					 + '/' + CONVERT(varchar,@kpsWeek)
					 + '/' + CONVERT(varchar,@day)
					 + '/' + CONVERT(varchar, (@currRevType+ 1));

					 IF(ISNULL(@production, 0) <> ISNULL(@oldProduction, 0))
					 BEGIN
					 INSERT INTO [dbo].[ProductionCard]
							   ([RevisionType]
							   ,[LocationCode]
