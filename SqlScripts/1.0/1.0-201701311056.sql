 IF EXISTS(SELECT * FROM sys.procedures WHERE NAME LIKE 'BaseExeReportByProcessGenerator')
 BEGIN
      DROP PROCEDURE [dbo].[BaseExeReportByProcessGenerator]
 END
 GO

/****** Object:  StoredProcedure [dbo].[BaseExeReportByProcessGenerator]    Script Date: 1/31/2017 10:51:57 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[BaseExeReportByProcessGenerator]
