	...
	SELECT
		...
		COALESCE(d.JKNRP / nullif(mtr.Jkn,0) , 0) AS JKNBox,
		COALESCE(d.JL1RP / nullif(mtr.jl1,0) , 0) AS Jl1Box,
		COALESCE(d.JL2RP / nullif(mtr.Jl2,0) , 0) AS Jl2Box,
		COALESCE(d.JL3RP / nullif(mtr.Jl3,0) , 0) AS Jl3Box,
		COALESCE(d.JL4RP / nullif(mtr.Jl4,0) , 0) AS Jl4Box
