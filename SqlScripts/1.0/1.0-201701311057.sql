 IF EXISTS(SELECT * FROM sys.procedures WHERE NAME LIKE 'ExtendedExeReportByProcessGenerator')
 BEGIN
      DROP PROCEDURE [dbo].[ExtendedExeReportByProcessGenerator]
 END
 GO

/****** Object:  StoredProcedure [dbo].[ExtendedExeReportByProcessGenerator]    Script Date: 1/31/2017 10:52:05 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[ExtendedExeReportByProcessGenerator]
