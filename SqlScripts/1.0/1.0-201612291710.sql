IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WAGES_ABSENT_REPORT_BYEMPLOYEE_DETAIL]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[WAGES_ABSENT_REPORT_BYEMPLOYEE_DETAIL]
...
CREATE PROCEDURE [dbo].[WAGES_ABSENT_REPORT_BYEMPLOYEE_DETAIL]
(	
		@paramStartDate DATE
	,	@paramEndDate	DATE
