/****** Object:  UserDefinedFunction [dbo].[GetUserAndEmail]    Script Date: 2/14/2017 1:50:07 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN
		INSERT INTO @UserAndEmail
			...
			)  AND ad.StatusActive = 1 AND ExpiredDate >  CONVERT(DATE, GETDATE())
	END;
	...
	BEGIN
		INSERT INTO @UserAndEmail
			...
			) AND ad.StatusActive = 1 AND ExpiredDate >  CONVERT(DATE, GETDATE()) AND ru.Location = @LocationCode
	END
