IF  EXISTS (SELECT * FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ENTRY_SAME_GROUP_ACV]'))
	DROP PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ENTRY_SAME_GROUP_ACV]
GO
/****** Object:  StoredProcedure [dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ENTRY_SAME_GROUP_ACV]    Script Date: 9/28/2016 4:59:21 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ENTRY_SAME_GROUP_ACV]
