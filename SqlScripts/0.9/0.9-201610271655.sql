...
/****** Object:  View [dbo].[TPOGenerateP1TemplateView]    Script Date: 27-Oct-16 4:51:39 PM ******/
SET ANSI_NULLS ON
GO
...
-- ticket : http://tp.voxteneo.co.id/entity/10764
-- date	  : 2016-10-27
-- description: add column TPOFeeCode
ALTER VIEW [dbo].[TPOGenerateP1TemplateView]
AS
SELECT 
	'1' as RowOrder,
	TPOFeeCode as TPOFeeCode,
