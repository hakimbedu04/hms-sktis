...
ALTER PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ENTRY_EMPTY_ACV_V2]
(
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						SET @workhour = 0;
						IF EXISTS(SELECT * FROM MstGenHoliday WHERE HolidayDate = @tmpEffDate AND LocationCode = @empUpd_LocationCode)
						BEGIN 
