/****** Object:  View [dbo].[MntcInventoryAll]    Script Date: 10/20/2016 17:39:12 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[MntcInventoryAll]'))
DROP VIEW [dbo].[MntcInventoryAll]
GO
...
-- Description: [MntcInventoryDeltaView] cancel [TableDeltaView]
-- Author: wahyu
