/****** Object:  StoredProcedure [dbo].[INSERT_WORKER_ASSIGNMENT_BYSYSTEM]    Script Date: 9/13/2016 2:25:37 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	FROM @temp where (SourceLocationCode = @locationCode  and SourceUnitCode = @unitCode) OR (DestinationLocationCode = @locationCode AND DestinationUnitCode = @unitCode)
