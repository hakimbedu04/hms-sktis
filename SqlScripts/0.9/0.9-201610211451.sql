/****** Object:  StoredProcedure [dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ACV_V2]    Script Date: 10/21/2016 2:49:25 PM ******/
IF  EXISTS (SELECT * FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ACV_V2]'))
	DROP PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ACV_V2]
GO
...
CREATE PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ASSIGNMENT_ACV_V2]
(
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					IF(@destGroupCode = @empUpd_GroupCode)
					BEGIN
						EXEC [EMPJOBDATA_SCHEDULER_ASSIGNMENT_ENTRY_SAME_GROUP_ACV_V2] @empUpd_ID, @empUpd_Number, @empUpd_EffDate, @empUpd_LocationCode,
					...
					BEGIN
						IF(@empUpd_Status  = '5')
						BEGIN
							EXEC [EMPJOBDATA_SCHEDULER_ASSIGNMENT_ENTRY_ACV_V2] @empUpd_ID, @empUpd_Number, @empUpd_EffDate, @empUpd_LocationCode, @empUpd_GroupCode,
