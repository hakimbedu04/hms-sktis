/****** Object:  StoredProcedure [dbo].[EDIT_WORKER_ABSENTEEISM_FROM_ENTRY]    Script Date: 9/23/2016 2:38:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[EDIT_WORKER_ABSENTEEISM_FROM_ENTRY]
						...
						BEGIN
							...
							BEGIN /** Checking if start date absent is no closing payroll or holiday **/
								...
								BEGIN /** Checking if previous day is closing payroll or holiday **/
									...
									END;
								END;
								ELSE IF([dbo].[CheckDateClosingPayrollOrHoliday](DATEADD(DAY, 1, @nextDay), @LocationCode) = 1)
								BEGIN
