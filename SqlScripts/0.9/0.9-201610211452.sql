/****** Object:  StoredProcedure [dbo].[EMPJOBDATA_SCHEDULER_ABSENTEEISM_ENTRY_ACV_V2]    Script Date: 10/21/2016 2:50:03 PM ******/
IF  EXISTS (SELECT * FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[EMPJOBDATA_SCHEDULER_ABSENTEEISM_ENTRY_ACV_V2]'))
	DROP PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ABSENTEEISM_ENTRY_ACV_V2]
GO
/****** Object:  StoredProcedure [dbo].[EMPJOBDATA_SCHEDULER_ABSENTEEISM_ENTRY_ACV_V2]    Script Date: 10/21/2016 2:50:03 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ABSENTEEISM_ENTRY_ACV_V2]
...
BEGIN
	...
	BEGIN
		...
		@isFromAbsenteeism = CASE WHEN ActiveInAbsent = 1 THEN 1 ELSE 0 END
