/****** Object:  StoredProcedure [dbo].[EDIT_PLANT_PRODUCTION_ENTRY]    Script Date: 10/18/2016 11:41:38 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Description: adding updatedby and updateddate
-- Author: AZKA
-- Updated: 5.0 - 2016/10/18
-- =============================================
