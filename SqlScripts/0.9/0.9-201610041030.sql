IF  EXISTS (SELECT * FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[EMPJOBDATA_SCHEDULER_ENTRY_EMPTY_ACV]'))
	DROP PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ENTRY_EMPTY_ACV]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[EMPJOBDATA_SCHEDULER_ENTRY_EMPTY_ACV]
(
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						FROM ExePlantProductionEntryVerification WHERE ProductionDate = @tmpEffDate and LocationCode = @empUpd_LocationCode;
					END
