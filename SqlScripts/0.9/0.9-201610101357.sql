/****** Object:  View [dbo].[ExePlantWorkerAbsenteeismView]    Script Date: 10/10/2016 10:06:55 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT      wa.EmployeeNumber, 
			(SELECT TOP 1 EmployeeName FROM MstPlantEmpJobsDataAll WHERE EmployeeID = wa.EmployeeID) as EmployeeName, 
			(SELECT TOP 1 ProcessSettingsCode FROM MstPlantEmpJobsDataAll WHERE EmployeeID = wa.EmployeeID) as ProcessSettingsCode, 
			wa.GroupCode, 
