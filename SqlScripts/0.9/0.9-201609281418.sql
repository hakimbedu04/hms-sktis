IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DefaultExeReportByProcess]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[DefaultExeReportByProcess]
GO
-- =============================================
-- Author:		Abud
...
CREATE PROCEDURE [dbo].[DefaultExeReportByProcess]
