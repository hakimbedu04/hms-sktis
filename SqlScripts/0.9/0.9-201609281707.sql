...
GO
/****** Object:  StoredProcedure [dbo].[EMPJOBDATA_PopulateUpd]    Script Date: 9/28/2016 5:05:23 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT
	  ...
	  'System' as UpdatedBy
	FROM MSTEMPPSFT3 AS A, (SELECT EMPLOYEE_ID, MAX(LAST_UPD_NO_PEN) as LAST_UPD FROM MSTEMPPSFT2 GROUP BY EMPLOYEE_ID) B
