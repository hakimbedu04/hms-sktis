...
/****** Object:  View [dbo].[TPOFeeApprovalView]    Script Date: 10/19/2016 10:36:52 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[TPOFeeApprovalView]'))
DROP VIEW [dbo].[TPOFeeApprovalView]
GO

USE [SKTIS]
GO

/****** Object:  View [dbo].[TPOFeeApprovalView]    Script Date: 10/19/2016 10:36:53 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[TPOFeeApprovalView]
AS
    SELECT mgl.LocationCode,
		...
		roles2.RolesCode AS DestinationRolesCodes,
		utl.CreatedBy PIC,
        th.BrandGroupCode,
        th.TPOFeeTempID,
        th.CurrentApproval,
