...
{
    public class PlanTPOTPKModel
    {
        public string TPKTPOStartProductionDate { get; set; }
        ...
        public float? TotalWorkHours1Prev3Weeks { get; set; }
        public float? TotalWorkHours2Prev3Weeks { get; set; }
        public float? TotalWorkHours3Prev3Weeks { get; set; }
        public float? TotalWorkHours4Prev3Weeks { get; set; }
        public float? TotalWorkHours5Prev3Weeks { get; set; }
        public float? TotalWorkHours6Prev3Weeks { get; set; }
        public float? TotalWorkHours7Prev3Weeks { get; set; }
        public float? TotalActualProductionPrev3Weeks { get; set; }
        public int? TotalProdGroup { get; set; }
    }
}
