USE [SKTIS]
GO
/****** Object:  UserDefinedFunction [dbo].[GetDeltaViewFunction]    Script Date: 07/06/2017 11:30:28 ******/
SET ANSI_NULLS ON
GO
...
ALTER FUNCTION [dbo].[GetDeltaViewFunction]
(	
...
--Wahyu: Item Movement (transaction date) source
         ...
         WHERE a.TransferDate = @InventoryDate
           ...
           AND a.QtyTransfer > 0
           AND CONVERT(VARCHAR(10),a.UpdatedDate,110)=CONVERT(VARCHAR(10),GETDATE(),110)
           --AND CONVERT(VARCHAR(10),a.TransferDate,110)=@InventoryDate
           -- update from  UpdateDate to CreatedDate avoid stock taken twice
         GROUP BY b.InventoryDate,
                  b.LocationCode,
                  b.UnitCode,
...
--Wahyu: Item Movement (transaction date) destination
         ...
         WHERE a.ReceiveDate = @InventoryDate
           ...
           AND a.ItemCode = b.ItemCode
           AND a.QtyReceive > 0
           AND CONVERT(VARCHAR(10),a.ReceiveDate,110)=@InventoryDate
           --AND CONVERT(VARCHAR(10),a.UpdatedDate,110)=CONVERT(VARCHAR(10),GETDATE(),110)
         GROUP BY b.InventoryDate,
                  b.LocationCode,
                  b.UnitCode,
